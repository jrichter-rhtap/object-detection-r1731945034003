...
3) Access the `workbench` named `object-detection-r1731945034003-notebook`.
...
5) In the terminal, run `cd object-detection-r1731945034003` to navigate to your sample app's directory.
